...
Route::prefix('/opac')->group(function() {
    ...
    //periodicals
    Route::get('/magazines', [PeriodicalController::class, 'opacGetMagazines']);
    Route::get('/journals', [PeriodicalController::class, 'opacGetJournals']);
    Route::get('/newspapers', [PeriodicalController::class, 'opacGetNewspapers']);
    ...
    //projects
    Route::get('/thesis', [ProjectController::class, 'opacGetThesis']);
    Route::get('/capstone', [ProjectController::class, 'opacGetCapstone']);
    Route::get('/research', [ProjectController::class, 'opacGetResearch']);
    Route::get('/dissertation', [ProjectController::class, 'opacGetDissertation']);
    Route::get('/feasibility', [ProjectController::class, 'opacGetFeasibility']);
    Route::get('/project/{id}', [ProjectController::class, 'getProject']);
});